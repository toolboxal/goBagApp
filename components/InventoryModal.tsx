...
const InventoryModal = ({ openModal, setOpenModal, selectedItem }: Props) => {
  ...
  const categoryIcons = {
    food: <Salad size={50} color={theme.accent6} strokeWidth={2} />,
    medicine: <Pill size={50} color={theme.accent6} strokeWidth={2} />,
    supplies: <Flashlight size={50} color={theme.accent6} strokeWidth={2} />,
    clothing: <Shirt size={50} color={theme.accent6} strokeWidth={2} />,
  }
