...
const Form = () => {
  ...
  const {
    ...
    defaultValues: {
      name: '',
      quantity: 1,
      dateExpiry: add(today, { months: 3 }).toISOString(),
      notes: '',
    },
  })
            ...
            <View style={{ position: 'absolute', right: -10, bottom: 0 }}>
              <DropdownMenu.Root>
                <DropdownMenu.Trigger>
                  ...
                  >
                    <Camera size={20} color={theme.primary7} strokeWidth={2} />
                  </View>
                </DropdownMenu.Trigger>
                <DropdownMenu.Content>
                  <DropdownMenu.Item key="camera" onSelect={handleCameraPress}>
            ...
            render={({ field: { onChange, onBlur, value } }) => (
              ...
              >
                <TextInput
                  ...
                  style={[
                    styles.textInput,
                    { backgroundColor: theme.primary1, color: theme.primary7 },
                  ]}
