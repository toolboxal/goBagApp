          ...
          >
            {categoryArr.map((category) => (
              ...
              >
                ...
                >
                  {
                    data.filter((item) => item.category === category.type)
                      .length
                  }
                </Text>
              </View>
          ...
          >
            ...
            <Text
              style={{
                ...
                fontSize: size.xxxl,
                color:
                  toReplaceSoon.length > 0 ? theme.warning : theme.primary7,
              }}
            >
          ...
          >
            <View>
              <Text style={styles.contactlabel}>{`critical: ${
                contacts?.filter((item) => item.priority === 'critical')
                  .length || 0
              }`}</Text>
              ...
              <Text style={styles.contactlabel}>{`normal: ${
                contacts?.filter((item) => item.priority === 'normal').length ||
                0
              }`}</Text>
            </View>
            <View
